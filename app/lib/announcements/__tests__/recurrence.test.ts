...
describe('getNextOccurrence', () => {
  ...
  it('returns eventDate for one-time event on the same day', () => {
    const result = getNextOccurrence(d('2026-03-01'), null, new Date('2026-03-01T23:59:00.000Z'))
    expect(result).toEqual(d('2026-03-01'))
  })
