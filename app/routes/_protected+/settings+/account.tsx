...
export default function AccountPage({ actionData }: Route.ComponentProps) {
  ...
  const changeError =
    intent === 'changePassword' && actionData && 'error' in actionData ? actionData.error : null
  const changeSuccess =
    intent === 'changePassword' && actionData && 'success' in actionData ? actionData.success : null
  const deleteErrors =
  ...
  return (
    <div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="from-destructive/5 ring-destructive/30 bg-gradient-to-b to-transparent ring-1">
          <CardHeader>
